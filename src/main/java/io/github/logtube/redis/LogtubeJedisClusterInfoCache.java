 ...
 */
public class LogtubeJedisClusterInfoCache {
    ...
    public LogtubeJedisClusterInfoCache(final GenericObjectPoolConfig poolConfig, int timeout) {
        this(poolConfig, timeout, timeout, null);
    }

    public LogtubeJedisClusterInfoCache(final GenericObjectPoolConfig poolConfig, final int connectionTimeout,
    ...
    public JedisPool setupNodeIfNotExist(HostAndPort node) {
        ...
        try {
            ...
            JedisPool nodePool = new LogtubeJedisPool(poolConfig, node.getHost(), node.getPort(), connectionTimeout,
                    soTimeout, password, 0, null, false, null, null, null);
    ...
    public JedisPool setupNodeIfNotExist(HostAndPort node, boolean ssl) {
        ...
        try {
            ...
            JedisPool nodePool = new LogtubeJedisPool(poolConfig, node.getHost(), node.getPort(), connectionTimeout,
                    soTimeout, password, 0, null, ssl, null, null, null);
            nodes.put(nodeKey, nodePool);
            return nodePool;
        } finally {
            w.unlock();
    ...
    public JedisPool setupNodeIfNotExist(HostAndPort node, boolean ssl, SSLSocketFactory sslSocketFactory,
        ...
        try {
            ...
            JedisPool nodePool = new LogtubeJedisPool(poolConfig, node.getHost(), node.getPort(), connectionTimeout,
                    soTimeout, password, 0, null, ssl, sslSocketFactory, sslParameters, hostnameVerifier);
            nodes.put(nodeKey, nodePool);
            return nodePool;
        } finally {
            w.unlock();
