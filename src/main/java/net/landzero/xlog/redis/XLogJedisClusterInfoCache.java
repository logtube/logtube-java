 ...
 */
public class XLogJedisClusterInfoCache {
    ...
    public XLogJedisClusterInfoCache(final GenericObjectPoolConfig poolConfig, int timeout) {
        this(poolConfig, timeout, timeout, null);
    }

    public XLogJedisClusterInfoCache(final GenericObjectPoolConfig poolConfig, final int connectionTimeout,
    ...
    public JedisPool setupNodeIfNotExist(HostAndPort node) {
        ...
        try {
            ...
            JedisPool nodePool = new XLogJedisPool(poolConfig, node.getHost(), node.getPort(), connectionTimeout,
